...
INT_PTR CALLBACK ProcDialog(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:
		...
		if (!(hEdit = CreateWindowEx(0L, TEXT("Edit"), TEXT("Редактор"), WS_CHILD | WS_BORDER | WS_VISIBLE, 20, 20, 160, 40, hDlg, (HMENU)(IDC_EDIT2), NULL, NULL)))
			return (-1);

		if (!(hListBox = CreateWindowEx(0L, TEXT("ListBox"), TEXT("Список"), WS_CHILD | WS_BORDER | WS_VISIBLE, 200, 20, 160, 180, hDlg, (HMENU)(IDC_LISTBOX2), NULL, NULL)))
			return (-1);
