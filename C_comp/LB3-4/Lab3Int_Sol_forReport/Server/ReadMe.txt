========================================================================
    ACTIVE TEMPLATE LIBRARY : Lb3Ind_autosvr Project Overview
========================================================================

AppWizard has created this Lb3Ind_autosvr project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

Lb3Ind_autosvr.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

Lb3Ind_autosvr.vcxproj.filters
...
Lb3Ind_autosvr.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Lb3Ind_autosvr.h)
        GUID definitions                                (Lb3Ind_autosvr_i.c)
        A type library                                  (Lb3Ind_autosvr.tlb)
        Marshaling code                                 (Lb3Ind_autosvr_p.c and dlldata.c)

Lb3Ind_autosvr.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Lb3Ind_autosvr.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Lb3Ind_autosvr.pch and a precompiled types file named StdAfx.obj.
...
Lb3Ind_autosvrps.vcxproj
	...
	dlldata.c, Lb3Ind_autosvr_i.c and Lb3Ind_autosvr_p.c which are required
	to build the proxy/stub DLL.

Lb3Ind_autosvrps.vcxproj.filters
